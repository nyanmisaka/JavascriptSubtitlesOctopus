...
var SubtitlesOctopus = function (options) {
    ...
    self.fallbackFont = options.fallbackFont || 'default.ttc'; // URL to override fallback font, for example, with a CJK one. Default fallback font is Liberation Sans (Optional)
